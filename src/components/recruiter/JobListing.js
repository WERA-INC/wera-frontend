          ...
          <div className="col-3">
            <div class="card company-profile" style={{ width: 300 }}>
              <div class="card-body bluey text-light">
                <h2 class="card-title fw-bold mb-3">SAFARICOM</h2>
            ...
            <div className="col-4">
              ...
              >
                ...
                <p>
                  ...
                  custom-built computing infrastructure platforms such as network
                  servers, storage, OEM/ODM appliances & embedded systems. For
                  more than 15 years, customer have trusted us for our innovative
                  problem solving combined with holistic design, engineering,
                  manufacturing, logistic and global support services.
                </p>
                <h4 className="fw-bold mt-4">Job Description</h4>
                <p>
                  We are looking for a Back-End Engineer to design and develop our
                  SaaS platform that enables researchers to manage their
                  ...
                  data pipelines to enrich and interact with data from over half a
                  billion cells. You will work in an interdisciplinary team
                  composed of data scientists, bioinformaticians, biologists, and
                  software engineers to help solve hard problems that improve
                  biological research and ultimately, health outcomes, across all
                  of biology.
                </p>
                ...
                <ul>
                  ...
                  <li className="mt-2">
                    <i class="bi bi-arrow-up-right-circle-fill me-3"></i>
                    Work in an interdisciplinary team composed of data scientists,
                    bioinformaticians, biologists, and software engineers
                  </li>
                  <li className="mt-2">
                    <i class="bi bi-arrow-up-right-circle-fill me-3"></i>
                    Help solve hard problems that improve biological research and
                    health outcomes
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li className="mt-2">
                    <i class="bi bi-arrow-up-right-circle-fill me-3"></i>
                    Strong problem-solving, debugging, and analytical skills with
