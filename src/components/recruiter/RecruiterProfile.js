...
const RecruiterProfile = () => {
  return (
    <div>
    <div class="w-full max-w-sm p-3 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-3" action="#">
            <h5 class="text-xl font-medium text-gray-900 dark:text-white">Moringa  BootCamp</h5>
            <div>
