...
const Profiles = () => {
  ...
  return (
    <>
      {data.id !== undefined ? (
        <div
          className="text-gray-950 align-items-center p-5"
          style={{
            ...
            >
              <div class="p-4 md:p-12 text-center ">
                <div
                  ...
                  style={{
                    backgroundImage: `url("https://img.freepik.com/free-vector/freelancer-concept-illustration_114360-7590.jpg?size=626&ext=jpg")`,
                  }}
                ></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1 mt-2">
                  {data.educations.map((edu) => (
                    <div class="max-w-sm rounded overflow-hidden shadow-lg mb-3 mx-auto bg-cyan-200 bg-opacity-40">
                      <div class="px-6 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1 mt-2">
                  {data.experiences.map((exp) => (
                    <div class="max-w-sm rounded overflow-hidden shadow-lg mb-3 mx-auto bg-cyan-200 bg-opacity-40">
                      <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">{exp.company}</div>
                        <p class="text-gray-700 text-base">{exp.year}</p>
                        <p class="text-gray-700 text-base">
                          {exp.job_description}
                        </p>
                      </div>
