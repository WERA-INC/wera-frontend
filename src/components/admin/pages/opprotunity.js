  ...
  return (
    <>
      {data.id !== undefined ? (
        ...
        >
          <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 p-5 ">
            <div
              id="profile"
            ...
            >
              <div class="p-4 md:p-12 text-center">
                <div
                  ...
                  style={{
                    backgroundImage: `url("https://img.freepik.com/free-vector/job-vacancy-background-with-chair-flat-style_23-2147875408.jpg?size=626&ext=jpg")`,
                  }}
                ></div>
                ...
                <div class="mt-3 max-w-sm rounded overflow-hidden shadow-lg mb-3 mx-auto bg-cyan-200 bg-opacity-40">
                  <div class="px-6 py-4">
                    <h1 class="text-3xl font-bold pt-8 lg:pt-0 uppercase">
